...
declare module '$env/static/private' {
	...
	export const ATSEARCH_FIREHOSE_COLLECTIONS: string;
	...
	export const ATSEARCH_FIREHOSE_URL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		ATSEARCH_FIREHOSE_COLLECTIONS: string;
